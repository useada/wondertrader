...
public: //交易函数
	...
	//买券还券(指定合约)
	Order credit_repay_share_by_buying_share_on_debt(const char *symbol, int volume, double price, const char *debtsno, int order_type = OrderType_Limit, int order_duration = OrderDuration_Unknown, int order_qualifier = OrderQualifier_Unknown, const char *account = NULL);
	//卖券还款
	...
	//卖券还款(指定合约)
	Order credit_repay_cash_by_selling_share_on_debt(const char *symbol, int volume, double price, const char *debtsno, int order_type = OrderType_Limit, int order_duration = OrderDuration_Unknown, int order_qualifier = OrderQualifier_Unknown, const char *account = NULL);
	//担保品买入
	...
	//直接还券(指定合约)
	Order credit_repay_share_directly_on_debt(const char *symbol, int volume, const char *debtsno, const char *account = NULL);
	//直接还款
	...
	//直接还款(指定合约与利息偿还)
	int credit_repay_cash_directly_ex(double amount, const char *debtsno, int bond_fee_only, const char *account = NULL, double *actual_repay_amount = NULL, char *error_msg_buf = NULL, int buf_len = 0);
	//担保品转入
